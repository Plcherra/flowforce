...
export const UPDATE_TEMPLATES: UpdateTemplate[] = [
  {
    ...
    type: 'announcement',
    preview: 'A clean, professional template for general company announcements.',
    backgroundStyle: {
      type: 'gradient',
      primary: '#3b82f6',
      secondary: '#1e40af',
  ...
  },
  {
    ...
    defaultContent: 'This is an urgent announcement that requires immediate attention...'
  },
  {
    id: 'news-company',
    name: 'Company News',
    ...
    type: 'news',
    preview: 'Modern template perfect for sharing company news and achievements.',
    backgroundStyle: {
      type: 'gradient',
      primary: '#059669',
      secondary: '#047857',
    ...
    defaultContent: 'We\'re thrilled to share some exciting news with our team...'
  },
  {
    id: 'event-meeting',
    name: 'Meeting & Events',
    ...
    type: 'event',
    preview: 'Professional template for event announcements and meeting invites.',
    backgroundStyle: {
      type: 'gradient',
      primary: '#7c3aed',
      secondary: '#5b21b6',
  ...
  },
  {
    ...
    type: 'news',
    preview: 'Vibrant template perfect for celebrating achievements and milestones.',
    backgroundStyle: {
      type: 'pattern',
      primary: '#f59e0b',
      secondary: '#d97706',
    ...
    defaultContent: 'Let\'s take a moment to celebrate this amazing achievement...'
  }
];
