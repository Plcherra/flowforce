...
export const BUSINESS_TEMPLATES: BusinessTemplate[] = [
  {
    ...
    description:
      "Complete solution for restaurants, cafes, and food service operations with shift management, role-based access, and inventory tracking.",
    industry: "restaurant",
    icon: "Utensils",
    sections: [
      "dashboard",
  ...
  },
  {
    ...
    description:
      "Perfect for consulting firms, professional services, and office-based businesses focusing on project management and collaboration.",
  ...
  },
  {
    ...
    description:
      "Designed for retail stores, e-commerce businesses with inventory management, sales tracking, and customer service features.",
    industry: "retail",
    icon: "ShoppingCart",
    sections: [
      "dashboard",
  ...
  },
  {
    ...
    description:
      "Tailored for healthcare facilities, clinics, and medical practices with compliance, scheduling, and certification tracking.",
    industry: "healthcare",
    icon: "Heart",
    sections: [
      "dashboard",
  ...
  },
  {
    ...
    description:
      "Built for manufacturing facilities with production tracking, safety management, and quality control.",
