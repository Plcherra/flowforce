  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/enhanced-scheduling?tab=availability",
        icon: CalendarCheck,
        translationKey: "myAvailability",
      },
      {
    ...
    items: [
      {
        ...
        icon: Calculator,
        translationKey: "inventoryActions",
      },
      {
        name: "Inventory Count Execution",
        href: "/inventory-count-execution",
        icon: Receipt,
