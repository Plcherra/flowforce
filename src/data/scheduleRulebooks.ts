...
export const DEFAULT_SCHEDULE_RULEBOOK: ScheduleRulebook = {
  ...
  steps: [
      ...
      completionCriteria: [
        {
          ...
          description: 'Every pending PTO request is approved/denied and tagged with coverage notes.',
        ...
        },
        {
          ...
          description: 'Labor target (hours + cost) for each location is entered for the upcoming week.',
        ...
        },
        {
          ...
          description: 'New hires, role changes, and terminations are reflected in the employee roster.',
      ...
      blockers: [
        {
          ...
          message: 'Cannot start drafting the schedule until staffing signals are captured.',
    ...
    },
    {
      ...
      purpose: 'Generate draft shifts that satisfy coverage targets while respecting guardrails.',
      mode: 'assisted',
      allowedRoles: ['operations_manager', 'schedule_admin'],
      completionCriteria: [
        {
          ...
          description: 'Draft shifts cover each location/service period within ±5% of labor targets.',
          evidenceType: 'numeric',
          targetValue: 0.95,
        ...
        },
        {
          ...
          description: 'Each shift has required certifications/roles assigned (kitchen lead, FOH closer, etc.).',
          evidenceType: 'checkbox',
        },
        {
          id: 'compliance-check-passed',
          label: 'Compliance check passed',
          description: 'Labor compliance (breaks, minors, max hours) verified with zero blocking violations.',
      ...
      blockers: [
        {
          ...
          message: 'Publishing is disabled while the draft coverage score is below target.',
      ...
      followUps: [
        {
          id: 'notify-gm-review',
          description: 'Notify General Manager that the draft is ready for review.',
      ...
      completionCriteria: [
        {
          ...
          description: 'GM approves the schedule in the system and adds any operational notes.',
          evidenceType: 'approval',
        ...
        },
        {
          ...
          description: 'Any conflicts identified during review are resolved or deferred with mitigation plan.',
          evidenceType: 'checkbox',
        },
      ],
      blockers: [
        {
          ...
          message: 'Schedule cannot be published until the GM approval step is complete.',
      ...
      completionCriteria: [
        {
          ...
          description: 'System fired publish action and notifications were sent.',
          evidenceType: 'external',
        ...
        },
        {
          ...
          description: 'Employees confirmed they saw their assignments or manager documented contact attempts.',
          evidenceType: 'numeric',
          targetValue: 0.95,
      ...
      followUps: [
        {
          ...
          description: 'Send handoff summary to shift leads and post schedule snapshot to the Ops channel.',
  ...
  constraints: [
    {
      ...
      description: 'Any action that puts an employee into overtime must be approved by People Ops first.',
      scope: 'action',
    ...
    },
    {
      ...
      description: 'Employees marked as minors cannot exceed 20 hours or work past 9 PM.',
      scope: 'global',
...
export const scheduleRulebooks: ScheduleRulebook[] = [DEFAULT_SCHEDULE_RULEBOOK];
