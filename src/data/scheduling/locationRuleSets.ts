...
const sharedWeekendTemplate: CoverageSlotTemplate[] = [
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Barista', start: '07:00', end: '15:00', headcount: 3, tags: ['peak'] },
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Barista', start: '11:00', end: '19:00', headcount: 3, tags: ['peak'] },
  { area: 'FOH', roleId: 'foh_service_lead', roleName: 'Floor Lead', start: '09:00', end: '17:00', headcount: 1 },
  { area: 'FOH', roleId: 'foh_service_lead', roleName: 'Closer Lead', start: '15:00', end: '23:00', headcount: 1, isCloser: true },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook', start: '08:00', end: '16:00', headcount: 3, tags: ['peak'] },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook', start: '12:00', end: '20:00', headcount: 3, tags: ['peak'] },
  { area: 'BOH', roleId: 'boh_prep', roleName: 'Prep Cook', start: '06:00', end: '14:00', headcount: 2 },
  { area: 'BOH', roleId: 'boh_prep', roleName: 'Prep Cook', start: '14:00', end: '22:00', headcount: 1, isCloser: true }
];

const inmanWeekdayTemplate: CoverageSlotTemplate[] = [
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Barista', start: '06:30', end: '14:30', headcount: 2, tags: ['open'] },
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Barista', start: '10:00', end: '18:00', headcount: 2 },
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Barista Closer', start: '14:00', end: '22:00', headcount: 2, isCloser: true },
  { area: 'FOH', roleId: 'foh_service_lead', roleName: 'Floor Lead', start: '08:00', end: '16:00', headcount: 1 },
  { area: 'FOH', roleId: 'foh_host', roleName: 'Host', start: '09:00', end: '17:00', headcount: 1 },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook', start: '07:00', end: '15:00', headcount: 2 },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook Closer', start: '15:00', end: '23:00', headcount: 1, isCloser: true },
  { area: 'BOH', roleId: 'boh_prep', roleName: 'Prep Cook', start: '11:00', end: '19:00', headcount: 2 }
];

const oneCanalWeekdayTemplate: CoverageSlotTemplate[] = [
  { area: 'FOH', roleId: 'foh_barista', roleName: 'Morning Barista', start: '06:00', end: '12:30', headcount: 2, tags: ['open'] },
  { area: 'FOH', roleId: 'foh_cashier', roleName: 'Cashier', start: '07:00', end: '15:00', headcount: 2 },
  { area: 'FOH', roleId: 'foh_runner', roleName: 'Runner', start: '11:00', end: '19:00', headcount: 2 },
  { area: 'FOH', roleId: 'foh_service_lead', roleName: 'Service Lead', start: '09:00', end: '17:00', headcount: 1 },
  { area: 'FOH', roleId: 'foh_service_lead', roleName: 'Closer Lead', start: '14:00', end: '22:00', headcount: 1, isCloser: true },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook', start: '06:30', end: '14:30', headcount: 2, tags: ['open'] },
  { area: 'BOH', roleId: 'boh_line', roleName: 'Line Cook', start: '14:00', end: '22:00', headcount: 2, isCloser: true },
  { area: 'BOH', roleId: 'boh_prep', roleName: 'Prep Cook', start: '10:00', end: '18:00', headcount: 2 }
];
...
const inmanEmployees: CopilotEmployeeSeed[] = [
  ...
  },
  {
    ...
    qualificationIds: ['boh_line'],
    availability: [
      { weekday: 0, ranges: [{ start: '15:00', end: '23:00' }], canClose: true },
      { weekday: 2, ranges: [{ start: '15:00', end: '23:00' }], canClose: true },
      { weekday: 3, ranges: [{ start: '15:00', end: '23:00' }], canClose: true },
      { weekday: 4, ranges: [{ start: '15:00', end: '23:00' }], canClose: true },
      { weekday: 6, ranges: [{ start: '13:00', end: '21:00' }], canClose: true },
    ],
    maxHoursWeek: 30,
  },
  {
    ...
    availability: [
      ...
      { weekday: 5, ranges: [{ start: '12:00', end: '20:00' }], canClose: false },
    ],
    maxHoursWeek: 24,
    isTrainee: true,
  }
...
const oneCanalEmployees: CopilotEmployeeSeed[] = [
  ...
  },
  {
    ...
    qualificationIds: ['boh_line'],
    availability: [
      { weekday: 1, ranges: [{ start: '14:00', end: '22:30' }], canClose: true },
      { weekday: 2, ranges: [{ start: '14:00', end: '22:30' }], canClose: true },
      { weekday: 3, ranges: [{ start: '14:00', end: '22:30' }], canClose: true },
      { weekday: 4, ranges: [{ start: '14:00', end: '22:30' }], canClose: true },
      { weekday: 6, ranges: [{ start: '14:00', end: '22:30' }], canClose: true },
    ],
    maxHoursWeek: 32,
  },
  {
  ...
  },
  {
    ...
    availability: [
      ...
      { weekday: 4, ranges: [{ start: '12:00', end: '20:00' }], canClose: false },
    ],
    maxHoursWeek: 24,
    isTrainee: true,
  }
