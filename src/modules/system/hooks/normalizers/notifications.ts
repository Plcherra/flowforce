...
export const normalizeNotifications = (
  ...
  const escalationsSource = isRecord(source.escalations)
    ? source.escalations
    : {};
  ...
  return {
    ...
    digestEnabled: asBoolean(
      source.digestEnabled,
      DEFAULT_NOTIFICATIONS.digestEnabled,
    ),
