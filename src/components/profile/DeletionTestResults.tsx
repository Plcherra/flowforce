...
export default function DeletionTestResults({ testResults }: DeletionTestResultsProps) {
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between p-3 border rounded">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm">{getStatusText(testResults.loginAttemptAfterDeletion)}</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between p-3 border rounded">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm">{getStatusText(testResults.userDataCheck)}</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between p-3 border rounded">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm">{getStatusText(testResults.tokenRefreshAttempt)}</span>
        </div>
      </div>
    </div>
  );
