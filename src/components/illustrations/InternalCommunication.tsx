...
const InternalCommunicationSVG = lazy(() => Promise.resolve({
  default: () => (
    <svg 
      viewBox="0 0 300 200" 
    ...
    >
      ...
      <text x="90" y="78" textAnchor="middle" fill="white" fontSize="10">Hello team!</text>
      <polygon points="130,85 140,90 130,95" fill="#FF4081" />
      
      <rect x="170" y="100" width="80" height="30" fill="#e5e7eb" rx="15" />
      <text x="210" y="118" textAnchor="middle" fill="#374151" fontSize="10">Got it, thanks</text>
      ...
      <text x="250" y="75" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">3</text>
...
export function InternalCommunication() {
  return (
    <div className="w-full h-full bg-pink-50 rounded-lg p-4">
      <Suspense fallback={<IllustrationSkeleton title="Internal Communication" />}>
