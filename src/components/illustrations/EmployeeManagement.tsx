...
const EmployeeManagementSVG = lazy(() => Promise.resolve({
  default: () => (
    <svg 
      viewBox="0 0 300 200" 
    ...
    >
      ...
      {/* Org Chart Lines */}
      <line x1="75" y1="80" x2="125" y2="120" stroke="#e5e7eb" strokeWidth="2" />
      <line x1="175" y1="80" x2="125" y2="120" stroke="#e5e7eb" strokeWidth="2" />
