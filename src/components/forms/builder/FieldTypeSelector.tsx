...
import { 
  Plus, FileText, AlignLeft, Hash, ChevronDown, CheckCircle, Image, Calculator,
    ...
    <div className="flex-shrink-0 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-6 pr-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4 px-1">Basic Fields</h3>
          ...
          {/* Media & Files Section */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4 px-1">Media & Files</h3>
            <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4 px-1">Interactive Fields</h3>
            <div className="grid grid-cols-2 gap-3">
              {[...groupFieldsByCategory().location, ...groupFieldsByCategory().interactive].map((type) => (
                <Card 
                  key={type.value}
                  className="cursor-pointer hover:shadow-md transition-all duration-200 p-4 hover:border-primary/60 border border-border bg-card hover:bg-primary/8 active:scale-98 min-h-[80px] flex items-center"
                  onClick={() => onFieldTypeSelect(createField(type))}
