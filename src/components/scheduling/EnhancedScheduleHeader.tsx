  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4">
          <div className="mb-2 lg:mb-0">
            <h1 className="text-xl lg:text-2xl font-bold text-foreground">Schedule Management</h1>
            <p className="text-sm lg:text-base text-muted-foreground">{dateRangeText}</p>
          </div>
      ...
      <div className="grid grid-cols-2 lg:flex gap-2">
        ...
        <Button variant="outline" size="sm" className="col-span-2 lg:col-span-1 lg:w-auto">
