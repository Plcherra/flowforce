...
export function PersonalAvailabilityPanel({ className }: PersonalAvailabilityPanelProps) {
    ...
    return (
      <Card className={className}>
        <CardHeader>
          ...
          <CardDescription>Connect to your scheduling data to enable availability editing.</CardDescription>
        </CardHeader>
        <CardContent>
          <Alert className="border-primary/40 bg-primary/5 text-primary">
            ...
            <AlertDescription>
              The schedule is currently showing demo data. Once Supabase tables are available this section will let you
              adjust your working preferences.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
  ...
  return (
    <Card className={cn('border bg-background shadow-sm', className)}>
      ...
      <CardContent className="space-y-4">
        <Alert
          className={cn('border-primary/30', (availabilityQuery.data?.length ?? 0) === 0 && 'border-dashed')}
        >
          <CalendarCheck className="h-5 w-5 text-primary" />
          <AlertTitle>
          ...
          <AlertDescription>
            Choose the hours you prefer to work each day. Locked weeks still let you submit a change request for manager
            approval.
          </AlertDescription>
        </Alert>
