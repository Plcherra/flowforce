...
const makeShift = (id: string, userId: string, start: string, end: string, name: string) =>
  ({
    id,
...
describe('WeekView linked events', () => {
  it('adds chips when a meeting is linked to shifts and notifies selection', () => {
    const schedules: ShiftWithAssignments[] = [
      makeShift('shift-1', 'user-1', '2024-01-02T09:00:00.000Z', '2024-01-02T15:00:00.000Z', 'Opening'),
      makeShift('shift-2', 'user-2', '2024-01-02T12:00:00.000Z', '2024-01-02T20:00:00.000Z', 'Closing'),
    ];
    ...
    expect(screen.queryAllByRole('button', { name: /Team Sync$/ })).toHaveLength(0);
