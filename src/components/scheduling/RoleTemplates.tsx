...
import { Users, Coffee, ShoppingCart, Eye, UserCheck, Download, Share } from 'lucide-react';
...
const roleTemplates: Role[] = [
  {
    ...
    responsibilities: ['Prepare beverages', 'Maintain equipment', 'Customer interaction'],
    minShiftHours: 4,
    maxShiftHours: 8,
  },
  {
  ...
  },
  {
    ...
    responsibilities: ['Supervise staff', 'Handle escalations', 'Ensure quality'],
    minShiftHours: 6,
    maxShiftHours: 10,
  },
];
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">
                These color-coded templates help maintain consistency across schedules. 
                Each role has defined shift lengths and responsibilities for better planning.
              </p>
              <div className="flex gap-2">
