...
import { Building2, Mail, Twitter, Linkedin, Youtube, Github, Moon, Sun } from 'lucide-react';
      ...
      <div className="border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-3xl font-bold mb-4">{t('footer.stayUpdated')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><Link to="#" className="hover:text-white transition-colors">{t('landing.features')}</Link></li>
              <li><Link to="#" className="hover:text-white transition-colors">{t('landing.pricing')}</Link></li>
