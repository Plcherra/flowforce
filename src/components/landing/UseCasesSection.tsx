...
import { TrendingUp, Clock, Users, DollarSign, CheckCircle, Zap } from 'lucide-react';
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <Badge variant="outline" className="text-[#3F51B5] border-[#3F51B5] mb-4">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-[#3F51B5] to-indigo-600 rounded-2xl text-white">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-indigo-100">{t('landing.useCases.stats.employeesManaged')}</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-2">1.2M+</div>
              <div className="text-indigo-100">{t('landing.useCases.stats.tasksCompleted')}</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-2">98%</div>
              <div className="text-indigo-100">{t('landing.useCases.stats.customerSatisfaction')}</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-2">24/7</div>
              <div className="text-indigo-100">{t('landing.useCases.stats.supportAvailable')}</div>
            </div>
          </div>
        </div>
      </div>
