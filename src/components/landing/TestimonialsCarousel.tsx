    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <CardContent className="p-8 h-full flex flex-col">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-medium text-[#3F51B5]">{testimonial.company}</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-600 mb-8">{t('landing.testimonials.trustedBy')}</p>
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {/* Placeholder logos - in real implementation these would be actual company logos */}
            {['TechCorp', 'RetailMax', 'HealthPlus', 'ServicePro', 'GrowthCo'].map((company, index) => (
