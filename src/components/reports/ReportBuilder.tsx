...
export default function ReportBuilder({ report, onSuccess, onBack }: ReportBuilderProps) {
  ...
  const availableColumns = COLUMN_OPTIONS[formData.report_type as keyof typeof COLUMN_OPTIONS] || [];
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.report_type} onValueChange={(value) => 
                setFormData(prev => ({ ...prev, report_type: value as any, columns: [] }))
              }>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
