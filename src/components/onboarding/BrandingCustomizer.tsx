...
export default function BrandingCustomizer({ branding, onBrandingChange }: BrandingCustomizerProps) {
                ...
                <div className="relative border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                  {branding.logo ? (
                    <div className="space-y-2">
                      <img src={branding.logo} alt="Logo preview" className="max-h-16 mx-auto" />
                      <Button variant="outline" onClick={() => handleStyleChange('logo', undefined)}>
                        Remove Logo
                      </Button>
                    </div>
                  ) : (
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <Select value={branding.fontFamily} onValueChange={(value) => handleStyleChange('fontFamily', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                   ...
                   <div className="p-4 rounded border bg-gray-50 dark:bg-gray-800">
                     <div style={{ fontFamily: branding.fontFamily }}>
                       <h4 className="text-lg font-bold mb-2" style={{ 
                       ...
                       <p className="text-sm mb-2" style={{ 
                         ...
                         This is how your text will look with the selected font family and colors. Your workspace will use this typography throughout the interface.
                       </p>
                       ...
                       <div className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-600">
                         <div className="text-xs text-muted-foreground">
                           Font: <span style={{ fontFamily: branding.fontFamily }}>{branding.fontFamily.split(',')[0]}</span>
                         </div>
                       </div>
                     </div>
                   </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { value: 'modern', label: 'Modern', desc: 'Clean lines, minimal shadows' },
                      { value: 'classic', label: 'Classic', desc: 'Traditional, serif elements' },
                      { value: 'minimal', label: 'Minimal', desc: 'Ultra-clean, no borders' },
                      { value: 'bold', label: 'Bold', desc: 'Strong shadows, thick borders' }
                    ].map((style) => (
                      <div
                        key={style.value}
                        ...
                        onClick={() => handleStyleChange('headerStyle', style.value)}
                      >
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <div
                      ...
                      onClick={() => handleStyleChange('sidebarStyle', style.value)}
                    >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    { value: 'elevated', label: 'Elevated', class: 'rounded-lg shadow-lg' }
                  ].map((style) => (
                    <div
                      key={style.value}
                      ...
                      onClick={() => handleStyleChange('cardStyle', style.value)}
                    >
                      <div className="text-center">
                        <div className="font-medium text-sm">{style.label}</div>
                        <div className={`mt-2 w-full h-8 bg-gray-100 ${style.class}`}></div>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    { 
                      ...
                      style: { 
                        backgroundColor: '#f8f9fa',
                        backgroundImage: 'linear-gradient(45deg, #e9ecef 25%, transparent 25%), linear-gradient(-45deg, #e9ecef 25%, transparent 25%)',
                        backgroundSize: '20px 20px'
                      }
                    },
                    { 
                    ...
                    <div
                      ...
                      onClick={() => handleStyleChange('backgroundPattern', pattern.value)}
                    >
                      <div className="text-center">
                        <div className="font-medium text-sm mb-2">{pattern.label}</div>
                        <div 
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div 
                ...
                `}
                style={{
                  borderColor: branding.headerStyle === 'bold' ? branding.primaryColor : undefined
                }}
              >
                {branding.logo && (
            ...
            >
              <div className="text-sm text-gray-600 mb-2">Typography Sample</div>
              <h3 
                className={`
                  text-lg mb-2
              ...
              <p className="text-gray-700 text-sm">
                ...
                The font family and header styles create a cohesive look throughout your workspace.
              </p>
            </div>
          </div>
        </CardContent>
