...
export function useOnboardingNavigation({
  ...
  const steps = isCustomTemplate ? [
    { id: 1, title: 'Info', description: 'Your information and company details' },
    { id: 2, title: 'Template', description: 'Choose your business template' },
    { id: 3, title: 'Custom', description: 'Build custom template' },
    { id: 4, title: 'Sections', description: 'Customize your workspace sections' },
    { id: 5, title: 'Roles', description: 'Setup roles and positions' },
    { id: 6, title: 'Review', description: 'Review and complete setup' }
  ] : [
    { id: 1, title: 'Info', description: 'Your information and company details' },
    { id: 2, title: 'Template', description: 'Choose your business template' },
    { id: 3, title: 'Sections', description: 'Customize your workspace sections' },
