...
export class ValidationManager {
  static validateUserInfo(
    ...
    if (!userInfo.firstName.trim())
      errors.push(i18n.t("onboarding.validation.errors.firstName"));
    if (!userInfo.lastName.trim())
      errors.push(i18n.t("onboarding.validation.errors.lastName"));
    if (!userInfo.email.trim())
      errors.push(i18n.t("onboarding.validation.errors.email"));
    ...
    if (!companyInfo.name.trim())
      errors.push(i18n.t("onboarding.validation.errors.companyName"));
    if (!companyInfo.industry)
      errors.push(i18n.t("onboarding.validation.errors.industry"));
    if (!companyInfo.size)
      errors.push(i18n.t("onboarding.validation.errors.size"));
  ...
  static canProceedToStep(
    ...
    if (isCustomTemplate) {
      switch (step) {
        ...
        case 5:
          return (
            customRoles.length >= VALIDATION_RULES.ONBOARDING.MIN_ROLES_REQUIRED
          );
        case 6:
          return true;
        default:
