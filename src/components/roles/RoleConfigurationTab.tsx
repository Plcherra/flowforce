...
export default function RoleConfigurationTab() {
  const { can } = useCan();
  const { roles, isLoading, createRole, updateRole, deleteRole } = useCompanyRoles();
  ...
  const handleDeleteRole = async (roleId: string) => {
    if (window.confirm('Are you sure you want to deactivate this role? Users with this role will need to be reassigned.')) {
