...
const UserPermissionsTabLazy = lazy(() =>
  import('./UserPermissionsTab').then((module) => ({ default: module.UserPermissionsTab }))
);
        ...
        <div className="flex h-full flex-col">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex h-full flex-col">
            <div className="space-y-4 px-6 pt-4">
              <TabsList className={`grid w-full gap-2 ${auditEnabled ? 'grid-cols-3' : 'grid-cols-2'}`}>
            ...
            <div className="flex-1 overflow-hidden">
              <div className="h-full overflow-y-auto px-6 pb-6">
                ...
                <TabsContent value="permissions" className="mt-4 space-y-4">
                  <Suspense fallback={<TabPanelSkeleton message="Loading access controls..." />}>
                ...
                {auditEnabled && (
                  <TabsContent value="audit" className="mt-4 space-y-4">
                    <Suspense fallback={<TabPanelSkeleton message="Loading activity timeline..." />}>
