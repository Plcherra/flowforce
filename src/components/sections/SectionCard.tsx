...
import { Eye, EyeOff, Settings, Edit2, Trash2, MoreHorizontal, Copy } from 'lucide-react';
...
export default function SectionCard({ 
  ...
  return (
    <Card className={`transition-all ${isEnabled ? 'bg-green-50 border-green-200' : ''}`}>
          ...
          <div className="flex items-center space-x-3 flex-1">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 mt-1">
                <Badge className={`text-xs ${getSectionBadgeColor(section.category)}`}>
                  {section.category}
                </Badge>
              </div>
            </div>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    {!section.isCustom && can('systemSettings') && (
                      <DropdownMenuItem onClick={() => {/* TODO: Implement settings */}}>
