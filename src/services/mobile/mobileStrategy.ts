...
export const mobileStrategyDecision: MobileStrategyDecision = {
  ...
  v1MustDoWorkflows: [
    ...
    "inventory_counts_waste_stock_low_stock_purchasing_handoff",
    "mobile_profile_notifications_language_support_settings",
    "safe_area_navigation_touch_targets_mobile_forms_tables",
  ],
  appStoreRequirements: [
    "apple_developer_and_google_play_accounts",
    "bundle_ids_app_names_icons_splash_screenshots_metadata",
    "privacy_policy_terms_support_url_data_deletion_export",
    ...
    "dev_internal_testflight_play_internal_production_build_profiles",
  ...
  nativeEscalationTriggers: [
    "offline_counts_or_forms_data_loss_or_conflict_friction",
