...
const IdentifyPanel = lazy(
  () => import("@/features/operations/components/idea/IdentifyPanel"),
);
const DiagnosePanel = lazy(
  () => import("@/features/operations/components/idea/DiagnosePanel"),
);
const ExecutePanel = lazy(
  () => import("@/features/operations/components/idea/ExecutePanel"),
);
const AssessPanel = lazy(
  () => import("@/features/operations/components/idea/AssessPanel"),
);
