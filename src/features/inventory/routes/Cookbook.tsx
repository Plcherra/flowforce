        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Cookbook Coming Soon</h3>
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                A comprehensive recipe management system that integrates with your inventory for accurate costing and prep planning.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto mb-6">
                <Card className="border-dashed">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Store and organize recipes</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-dashed">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Link ingredients to inventory</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-dashed">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Automatic recipe costing</p>
                  </CardContent>
                </Card>
              </div>
