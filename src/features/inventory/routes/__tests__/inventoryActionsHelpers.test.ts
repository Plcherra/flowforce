...
const buildWasteForm = (overrides: Partial<WasteFormValues> = {}): WasteFormValues => ({
  item_id: '',
  location_id: '',
  quantity: '',
...
const buildAdjustmentForm = (overrides: Partial<AdjustmentFormValues> = {}): AdjustmentFormValues => ({
  item_id: '',
  location_id: '',
  adjustment_type: '',
  quantity: '',
...
const items: InventoryItem[] = [
  {
    ...
    name: 'Tomatoes',
    unit_id: 'unit-1',
    unit: { id: 'unit-1', name: 'Case', abbreviation: 'cs', unit_type: 'count', is_active: true },
    cost_per_unit: 3.5,
    min_stock_level: 1,
    max_stock_level: 5,
