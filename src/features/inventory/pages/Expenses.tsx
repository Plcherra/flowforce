...
export default function Expenses() {
  ...
  const canViewManagement =
    ["manager", "admin", "supervisor"].includes(normalizedRole) ||
    canApproveExpenses;
            ...
            <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Record reimbursements, store purchases, or payroll
          ...
          <TabsContent value="expenses" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Drill into reimbursements, payroll adjustments, and vendor
                  spend.
                </CardDescription>
              </CardHeader>
              <CardContent>
