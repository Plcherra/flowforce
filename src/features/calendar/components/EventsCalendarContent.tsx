...
export function EventsCalendarContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-44">
                  <DropdownMenuItem onClick={() => handleOpenSessionDialog('meeting')}>
                    <Video className="mr-2 h-4 w-4" />
                    Meeting
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => handleOpenSessionDialog('event')}>
      ...
      />
      <CreateVendorVisitDialog open={vendorDialogOpen} onOpenChange={handleToggleVendorDialog} />
    </div>
  );
}
