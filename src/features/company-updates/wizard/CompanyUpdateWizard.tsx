...
const STEP_COMPONENT_RENDERERS: Record<WizardStepId, (props: StepComponentProps) => React.ReactElement> = {
  ...
  return (
    <header className="border-b border-border/80 bg-background/95 px-8 py-4 backdrop-blur">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <DialogTitle className="text-2xl font-semibold">Create company update</DialogTitle>
...
function QuickActionRail({ actions, onJumpToStep }: { actions: QuickAction[]; onJumpToStep: (index: number) => void }) {
