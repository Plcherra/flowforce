...
export function RemindersPanel() {
  ...
  const getUpcomingReminders = () => {
    return reminders
      .filter(
        (reminder) =>
          !reminder.completed && new Date(reminder.remind_at) > new Date(),
      )
      .sort(
        (a, b) =>
  ...
  const getOverdueReminders = () => {
    return reminders.filter(
      (reminder) => !reminder.completed && isPast(new Date(reminder.remind_at)),
    );
  };
              ...
              {overdueReminders.length > 0 && (
                <div>
                  ...
                  {overdueReminders.map((reminder) => (
                    <div
                      key={reminder.id}
                      className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border-l-4 border-l-red-500 mb-2"
                    >
              ...
              {upcomingReminders.length > 0 ? (
                <div>
                  ...
                  {upcomingReminders.map((reminder) => (
                    <div
                      key={reminder.id}
                      className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg mb-2"
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2">
