  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Define authentication requirements, password resilience, and secure
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between gap-4 rounded-lg border p-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Require verified authenticator apps or passkeys for all user
                sign-ins.
              </p>
            </div>
            <Switch
              ...
              onCheckedChange={(value) =>
                setState((prev) => ({ ...prev, twoFactorRequired: value }))
              }
          ...
          <div className="flex items-center justify-between gap-4 rounded-lg border p-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Automatically enforce MFA for owners, company admins, and
                managers.
              </p>
            </div>
            <Switch
              ...
              onCheckedChange={(value) =>
                setState((prev) => ({ ...prev, enforceForAdmins: value }))
              }
              disabled={!canEdit || loading}
            />
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline">
              min {state.passwordPolicy.minLength} chars
            </Badge>
          </div>
                ...
                onChange={(event) =>
                  updatePasswordPolicy(
                    ...
                    Number(event.target.value) ||
                      state.passwordPolicy.minLength,
                  )
                }
                disabled={!canEdit || loading}
              />
            ...
            <Input
              ...
              onChange={(event) =>
                setState((prev) => ({
                  ...prev,
                  sessionTimeout:
                    Number(event.target.value) || prev.sessionTimeout,
                }))
              }
              disabled={!canEdit || loading}
            />
            <p className="text-xs text-muted-foreground">
              Users will be logged out after inactivity to protect sensitive
              data.
            </p>
          </div>
          <div className="space-y-2 rounded-lg border p-4">
            ...
            <Input
              ...
              onChange={(event) =>
                setState((prev) => ({
                  ...prev,
                  trustedDeviceWindow:
                    Number(event.target.value) || prev.trustedDeviceWindow,
                }))
              }
              disabled={!canEdit || loading}
            />
            <p className="text-xs text-muted-foreground">
              After this window, users must complete MFA again on trusted
              devices.
            </p>
          </div>
        </section>
              ...
              <Input
                ...
                onChange={(event) =>
                  updateTokenAccess(
                    "rotateEveryDays",
                    Number(event.target.value) ||
                      state.apiTokenAccess.rotateEveryDays,
                  )
                }
        ...
        <section className="space-y-3 rounded-lg border p-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateRowLevelSecurity("enforced", value)
              }
              disabled={!canEdit || loading}
            />
          </div>
          <div className="flex items-center justify-between rounded-md border px-3 py-2">
            <span className="text-xs text-muted-foreground">
              Allow external analytics access
            </span>
            <Switch
              checked={state.rowLevelSecurity.allowExternalAnalytics}
              onCheckedChange={(value) =>
                updateRowLevelSecurity("allowExternalAnalytics", value)
              }
