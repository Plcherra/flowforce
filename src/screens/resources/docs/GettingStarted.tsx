        ...
        <Card>
          ...
          <CardContent>
            <div className="prose max-w-none">
              ...
              <p>
                This guide will walk you through the essential steps to get your team up and running with FlowForce. 
                Follow these steps in order to ensure a smooth setup process.
              </p>
              ...
              <p>
                Once you've completed the basic setup, explore our other documentation sections:
              </p>
              <ul>
