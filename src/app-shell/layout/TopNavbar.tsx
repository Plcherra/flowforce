...
import { NotificationsPanel } from "@/app-shell/notifications/NotificationsPanel";
...
export function TopNavbar() {
  ...
  const _getRoleIconWithStyle = (role: string) => {
    ...
    return React.cloneElement(Icon, {
      className:
        "h-3 w-3 absolute -bottom-0.5 -right-0.5 text-white bg-primary rounded-full p-0.5 border border-white",
    });
  };
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-0.5 -right-0.5 h-4 w-4 bg-primary rounded-full flex items-center justify-center border-2 border-white dark:border-gray-900">
                  {getRoleIcon(profile?.role || "staff") &&
                    React.cloneElement(getRoleIcon(profile?.role || "staff"), {
            ...
            <div className="px-3 py-2">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <Badge
                    className={`text-xs ${getRoleBadgeColor(profile?.role || "staff")}`}
                  >
