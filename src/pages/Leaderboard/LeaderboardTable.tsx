    ...
    return (
      <Card className="border-dashed">
        ...
        <CardContent className="text-sm text-muted-foreground">
          Sync XP data from Supabase or assign your first tasks to populate the leaderboard.
        </CardContent>
      </Card>
    );
  }
          ...
          <TableBody>
            {entries.map((entry) => (
              <TableRow key={entry.employeeId}>
                ...
                <TableCell className="text-right font-semibold">{entry.xp.total.toLocaleString()}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
