...
vi.mock('@/components/ui/form', () => {
  ...
  const FormField = ({ render }: { render: (args: { field: { value: string; onChange: () => void } }) => ReactNode }) =>
...
vi.mock('@/components/employees/EmployeeDrawer', () => ({
  EmployeeDrawer: () => null,
}));
vi.mock('@/components/employees/InviteEmployeeDialog', () => ({
  InviteEmployeeDialog: () => null,
}));
vi.mock('@/components/employees/RoleManagerDialog', () => ({
  RoleManagerDialog: () => null,
}));
vi.mock('@/components/employees/PermissionManagerDialog', () => ({
  PermissionManagerDialog: () => null,
}));
vi.mock('@/components/employees/TeamActionsBar', () => ({
...
vi.mock('@/features/inventory/hooks/useVendorForm', () => ({
  useVendorForm: () => ({
    form: {
      control: {},
      handleSubmit: (cb: (values: unknown) => void) => (event?: { preventDefault?: () => void }) => {
