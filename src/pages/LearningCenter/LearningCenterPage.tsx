...
export function LearningCenterPage() {
  ...
  useEffect(() => {
    ...
    if (!trainingAdmin && (requestedTab === 'analytics' || requestedTab === 'admin')) {
  ...
  const allowedTabs: LearningTab[] = trainingAdmin ? ALL_TABS : ['overview', 'catalog'];
  const recommendedCourseIds = new Set(recommendations.map((recommendation) => recommendation.courseId));
