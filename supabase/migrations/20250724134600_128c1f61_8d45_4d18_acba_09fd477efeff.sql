...
-- Drop the SQL version of has_role that conflicts
-- Use CASCADE to automatically drop dependent policies/objects
-- Note: Policies will be recreated by later migrations if needed
