...
-- Note: Removing partial indexes with now() function due to immutability requirements
...
-- Add partial indexes for better performance on filtered queries (without now() function)
