...
CREATE INDEX idx_workflows_department_id ON public.workflows(department_id);
CREATE INDEX idx_workflow_steps_workflow_id ON public.workflow_steps(workflow_id);
CREATE INDEX idx_task_workflow_instances_task_id ON public.task_workflow_instances(task_id);
