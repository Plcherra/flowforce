-- Fix Performance Advisor warnings with essential indexes
-- Focusing on most critical performance improvements without problematic predicates
...
-- Safe partial indexes (avoiding now() function)
