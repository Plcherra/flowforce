-- Create inv_waste table with proper structure
...
-- Create RLS policies for inv_waste that work with the existing structure
...
USING (
  EXISTS (
    ...
    WHERE inv_items.id = inv_waste.item_id 
