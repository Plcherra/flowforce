-- Phase 10 forward migration: move path-aware sensitive file buckets to
-- private storage. Access remains tenant-scoped through storage.objects RLS,
-- while the app now opens files through short-lived signed URLs.
