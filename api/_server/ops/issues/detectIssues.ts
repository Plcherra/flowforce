import { computeTasksCompliance } from '../kpi/computeTasksCompliance.js';
import { computeInventoryHealth } from '../kpi/computeInventoryHealth.js';
import { computeLaborVsSales } from '../kpi/computeLaborVsSales.js';
...
export async function detectIssues({ orgId }: DetectIssuesOptions) {
  const logger = createServerLogger('detectIssues', { orgId, tags: ['detector', 'issues'] });
